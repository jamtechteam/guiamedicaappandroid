...
import LocationForm from 'src/components/Location/LocationForm/LocationForm.vue';
...
<template>
  <section
    class="window-height overflow-scroll bg-filter flex flex-center"
  >
    <!-- <CHeaderDinamic
    ...
    <section class="column q-pt-lg q-px-md">
      <div
        class="my-font-bold"
        style="font-size: 20px; font-weight: 100; color: #fff"
      >
        Filtrado por zona
      </div>
      <div
      ...
      <LocationForm class="q-mt-md" />
    </section>
  </section>
</template>

<style scoped lang="scss">
@import url('./LocationConfigPage.scss');
</style>
